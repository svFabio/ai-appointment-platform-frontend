                    ...
                    <div className="flex items-center justify-between">
                        <div>
                            ...
                            <div className="flex items-center gap-2">
                                <p className="text-2xl font-bold text-slate-800">{(overview?.ratingPromedio || 0).toFixed(1)}</p>
                                <div className="flex">
                                    {Array.from({ length: 5 }).map((_, i) => (
                                        <Star key={i} className={`w-4 h-4 ${i < Math.round(overview?.ratingPromedio || 0) ? 'fill-yellow-400 text-yellow-400' : 'text-slate-300'}`} />
                                    ))}
                                </div>
                            </div>
                        </div>
